...
public class TestItemService extends BaseService{
	...
	public startTestCase(testCaseName, parentId, launchId, parameters=null) {
		return this.startChildTestItem(testCaseName, 'TEST', parentId, launchId,parameters)
	}
	...
	public startNestedTestStep(testStepName, parentId, launchId, parameters=null) {
		return this.startNestedChildTestItem(testStepName, 'STEP', parentId, launchId, parameters)
	}
	...
	private startTestItem(itemName, itemType, launchId) {
		...
		KeywordUtil.logInfo("startTestItemRequest")
	...
	private startChildTestItem(itemName, itemType, parentId, launchId, parameters) {
		...
		KeywordUtil.logInfo("startChildTestItemRequest")
		this.logErrorResponse(res)
		return JSONUtils.getJSONObject(res)
	}

	//	{startNestedChildTestItemRequest}
	private startNestedChildTestItem(itemName, itemType, parentId, launchId, parameters) {
		this.setTestItemName(itemName)
		this.setTestItemType(itemType)
		this.setTestItemParentId(parentId)
		this.setTestParameter(parameters)
		this.setTestStats("false")
		this.launch.setLaunchId(launchId)
		def res = WS.sendRequest(startNestedChildTestItemRequest())
		KeywordUtil.logInfo("startNestedChildTestItemRequest")
		this.logErrorResponse(res)
		return JSONUtils.getJSONObject(res)
	}
	...
	private finishTestItem(testItemId) {
		...
		KeywordUtil.logInfo("finishTestItemRequestWithAutoStatus")
		this.logErrorResponse(res)
		return JSONUtils.getJSONObject(res)
	}
	...
	private finishTestItem(testItemId, status) {
		...
		KeywordUtil.logInfo("finishTestItemRequestWithDefineStatus")
	...
	private finishTestItem(testItemId, status, issueType) {
		...
		KeywordUtil.logInfo("finishTestItemRequest")
		this.logErrorResponse(res)
		return JSONUtils.getJSONObject(res)
	}
	...
	private setTestStats(testStats) {
	...
	private Closure<RequestObject> startNestedChildTestItemRequest
