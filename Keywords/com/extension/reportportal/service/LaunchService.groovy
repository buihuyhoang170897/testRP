...
public class LaunchService extends BaseService{
	...
	public startLaunch() {
		KeywordUtil.logInfo("startLaunchRequest")
		RequestObject req = startLaunchRequest()
		KeywordUtil.logInfo("url"+req.getRestUrl())
		KeywordUtil.logInfo("Request"+req.getHttpBody())
		def res = WS.sendRequest(req)
		//		KeywordUtil.logInfo("Request"+res.getResponseText()())
	...
	public finishLaunch(launchId) {
		...
		KeywordUtil.logInfo("finishLaunchRequest")
	...
	bodyTextData = {
		[
			//			('attributes'): [('key'): "string",('system'): false,('value'): "string"],
